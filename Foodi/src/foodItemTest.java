...
class foodItemTest {
	...
	public void testFoodItem() { 
		...
		FoodItem foodItem_forNull = null; 
		FoodItem foodItem_forNull2 = null;// FoodItem(); 
		FoodItem foodItem1 = null;//FoodItem(id, name, rank, calories, recipe, prepTime, meal);
		FoodItem foodItem2 = null;// FoodItem(id, name, rank, calories, recipe, prepTime, meal);
